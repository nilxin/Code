...
public class GreenPassWebServiceImpl extends AbstractService implements GreenPassWebService {
	...
	@Override
	@Transactional
	public void updateDoubleCheckStatus(String billId, String doubleCheckStatus,String currentUserWorkNo) {
		greenPassDriverMapper.updateDoubleCheckStatus(billId,doubleCheckStatus,currentUserWorkNo);
	}
	...
	@Override
	@Transactional(readOnly = true)
	public List<?> queryCheckTimeStatisticsByHours(Map<String, Object> map, Pageable page) {
		return greenPassDriverMapper.queryCheckTimeStatisticsByHours(map, page);
	}
